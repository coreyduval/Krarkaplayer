...
| **Early-win score** (geo, T2–8, earlier = better) | **~1.71** |
| TTK (non-wins penalized at turn 15) | ~6.2 |
| Win conditions | combat (Dualcaster / Krark-shimmer) ~77% · Urabrask/Vivi burn ~11% · Grapeshot storm-burn ~7% · Brain Freeze mill ~5% |
